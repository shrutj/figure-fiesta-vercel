...
const PaymentMethodModal = ({ isVisible, onClose, onPaymentSelect, totalAmount, userData }) => {
  ...
  const initiateRazorpayPayment = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://figurefiesta.com/api/create-order', { amount: totalAmount * 100 }); // Amount in paise
  ...
  const handlePaymentSuccess = (paymentResponse, paymentOrderId) => {
    ...
    axios.post('https://figurefiesta.com/api/payment-success', {
